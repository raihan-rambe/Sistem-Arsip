...
import androidx.appcompat.widget.Toolbar;
    ...
    import com.example.rensposi.Model.HistoryModel;
import com.example.rensposi.Adapter.HistoryAdapter;
...
import java.util.HashMap;
    ...
    public class history extends AppCompatActivity {
        ...
        String id_book = "", ID, barang, tanggal, stok, riwayat;
        String email;
        TextView tvNotFound;
        ...
        private void setupToolbar() {
            ...
            toolbar.setTitle("Riwayat Stok Barang");
        ...
        public void refreshList() {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                barang = cursor.getString(2);
                tanggal = cursor.getString(3);
                stok = cursor.getString(4);
                riwayat = "Stok Barang berhasil dipantau " + ID + " nama barang " + barang + " pada tanggal " + tanggal + ". " +
                        "Dengan jumlah Stok" + stok;
            }
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    builder.setItems(dialogitem, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int item) {
                            ...
                            try {
                                db.execSQL("DELETE FROM TB_STOK where id = " + selection + "");
                                id_book = "";
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
